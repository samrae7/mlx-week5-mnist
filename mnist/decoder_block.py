...
from mnist.cross_attention import CrossAttention
from mnist.feed_forward import FeedForward
...
class DecoderBlock(nn.Module):
    def __init__(self, embed_dim, num_layers, encoder_embed_dim):
        ...
        self.self_attn = SelfAttention(embed_dim=embed_dim, num_heads=3)
